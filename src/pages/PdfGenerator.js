...
function PdfGenerator() {
    ...
    useEffect(() => {
        ...
        axios.get('https://ims-ssn4.onrender.com/inventory/v1/customers', {
            method: 'GET',
            headers: {
    ...
    const generateBill = () => {
        ...
        axios.get(`https://ims-ssn4.onrender.com/inventory/v1/products/bill?customerId=${selectedCustomer}`, {
            method: 'GET',
            headers: {
                'Content-type': 'application/json',
                Authorization: 'Bearer ' + sessionStorage.getItem('token'),
